...
class _QrReaderViewState extends State<QrReaderView> {
  ...
  Widget build(BuildContext context) {
    if (defaultTargetPlatform == TargetPlatform.android) {
      return AndroidView(
        viewType: "me.hetian.plugins/flutter_qr_reader/reader_view",
        creationParams: {
          ...
          "rectWidth": (widget.rectWidth * window.devicePixelRatio).floor(),
          "isOnlyDecodeScanBoxArea": widget.isOnlyDecodeScanBoxArea
        },
