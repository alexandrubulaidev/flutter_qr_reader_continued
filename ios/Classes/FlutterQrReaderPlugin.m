...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    ...
    [registrar registerViewFactory:viewFactory withId:@"me.hetian.plugins/flutter_qr_reader/reader_view"];

    FlutterMethodChannel* channel = [FlutterMethodChannel
                                     methodChannelWithName:@"me.hetian.plugins/flutter_qr_reader"
